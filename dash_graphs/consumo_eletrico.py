...
<<<<<<< HEAD:dash_graphs/consumo_eletrico.py
...
s2=sum(ms2018)
ms2019 = [5366, 4136, 3915, 3683, 4667, 4476, 4866, 5696, 6162, 0, 0, 0]
s3=sum(ms2019)

camp2016 =[7350,5734,6770,7346,8282,9744,7902,7541,9128,7382,7125,7112]
...
s5=sum(camp2018)
camp2019 = [12595, 9918, 13403, 17575, 13512, 9809,10141,12481,14187,0,0,0]
s6=sum(camp2019)
...
s8 = sum(sj2018)
sj2019 = [5798, 6539, 4857, 5401, 4235, 4954,5384,6602,6550,0,0,0]
s9= sum(sj2019)
'''
...
s15 = sum(cid2019)
'''
ec2016 = [3935,1635+2090,1629+2088,1778+1851,1883+1850,2041+1803,2784+2135,3047+2181,2636+2100,2302+2087,1846+1898,1850+2003] 
...
ec2019 = [3220, 2999, 2080, 2210, 3956, 2610, 2426, 2827, 3243, 0, 0, 0]
...
s17=sum(rib2018)
rib2019 = [1688,1928,1789,2058,1091,962,1053,1243,1318,0,0,0]
s18=sum(rib2019)
...
s20 = sum(pn2018)
pn2019 = [2713, 2117, 2309, 2364, 2322, 2629,2366,2374,2890,0,0,0]
s21 = sum(pn2019)


>>>>>>> 7a824997b680b336d77a37d88444011dc1dcac64:dash_graphs/graphs.py
...
app.layout = html.Div(children=[
    ...
    dcc.Graph(
        id='sum_cid',
        figure={
            'data': [go.Pie(labels=['2017', '2018', '2019'], values=[ed.s13, ed.s14, ed.s15], hole=0.3)],
            'layout': {'title': 'Comparação Anual'}
        }
    ),
