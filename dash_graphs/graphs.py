...
s2=sum(ms2018)
ms2019 = [5366, 4136, 3915, 3683, 4667, 4476, 4866, 5696, 0, 0, 0, 0]
s3=sum(ms2019)
...
s5=sum(camp2018)
camp2019 = [12595, 9918, 13403, 17575, 13512, 9809,10141,12481,0,0,0,0]
s6=sum(camp2019)
...
s8 = sum(sj2018)
sj2019 = [5798, 6539, 4857, 5401, 4235, 4954,5384,6602,0,0,0,0]
s9= sum(sj2019)
...
ec2019 = [3220, 2999, 2080, 2210, 3956, 2610, 2426, 2827, 0, 0, 0, 0]
...
s17=sum(rib2018)
rib2019 = [1688,1928,1789,2058,1091,962,1053,1243,0,0,0,0]
s18=sum(rib2019)
...
s20 = sum(pn2018)
pn2019 = [2713, 2117, 2309, 2364, 2322, 2629,2366,2374,0,0,0,0]
s21 = sum(pn2019)
